...
/// Chat UI timeline ordering (aligned with WPF `ChatTimelineOrder`).
enum ChatTimelineOrder {
    /// While a turn is running, keep the live assistant bubble at the bottom (WPF appends tools after the bubble in list order).
